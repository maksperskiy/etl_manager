...
import { required } from "../../modules/validation/validators";
import "./Login.scss";
...
export default function LoginView() {
  ...
  return (
    <>
      {processing && (
        <ProgressBar className="etlm-login--progress" label="" hideLabel />
      )}
      <div className="etlm-login">
        <Form>
          ...
          <PasswordInput
            ...
            warnText={errors?.password?.message}
            disabled={processing}
          />
          <Button
            renderIcon={Login}
        ...
        <p>
          Have no account yet? <Link to="/register">Register here</Link>
        </p>
      </div>
    </>
  );
