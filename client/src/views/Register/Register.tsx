...
import { email, required, Same } from "../../modules/validation/validators";
...
export default function RegisterView() {
  ...
  return (
    <>
      {processing && (
        <ProgressBar className="etlm-register--progress" label="" hideLabel />
      )}
      <div className="etlm-register">
        <Form>
          ...
          <PasswordInput
            ...
            warn={!!errors?.password1}
            warnText={errors?.password1?.message}
            disabled={processing}
          />
          <PasswordInput
            id="repeatPassword"
            ...
            warn={!!errors?.password2}
            warnText={errors?.password2?.message}
            disabled={processing}
          />
          <Button
            renderIcon={Login}
